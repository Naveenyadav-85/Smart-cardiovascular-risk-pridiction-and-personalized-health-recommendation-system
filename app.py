...
def get_db():
    return mysql.connector.connect(
        host="localhost",
        user="root",
        password="N@veen@70322",  # change to your MySQL password
        database="heart_records"
    )
...
# Load ML Model
# -------------------------
models = joblib.load("models/heart_model.pkl")     # adjust path to where your model is saved
...
def predict():
    ...
    prob = models.predict_proba(scaled)[0].max()
...
def show_evaluation(report_id):
    ...
    # --- Load dataset ---
    df = pd.read_csv("C:\\HEART\\heart_clean.csv")  # adjust to your dataset path
...
def download_report(report_id):
    ...
    def header_footer(canvas, doc):
        ...
        try:
            bg_path = "C:/Users/Naveen/PycharmProjects/SCRAPRS/static/images/watermark.jpeg"
        ...
        # -------- Left Logo (Aurora) --------
        try:
            aurora_logo = "C:/Users/Naveen/PycharmProjects/SCRAPRS/static/images/auroralogo.jpg"
            canvas.drawImage(
                aurora_logo,
        ...
        # -------- Right Logo (logo5.png instead of Confidential text) --------
        try:
            right_logo = "C:/Users/Naveen/PycharmProjects/SCRAPRS/static/images/logo5.png"
            canvas.drawImage(
                right_logo,
        ...
        # -------- Hospital Name (center aligned, colorful) --------
        canvas.setFont("Helvetica-Bold", 16)
        canvas.setFillColor(colors.HexColor("#0d6efd"))  # Blue shade
        canvas.drawCentredString(page_width / 2, page_height - 40, "Aurora Smart Heart Care Hospital")

        # -------- Footer --------
        canvas.setFont("Helvetica", 8)
        canvas.setFillColor(colors.grey)
        canvas.drawString(40, 40, "Aurora Smart Heart Care Hospital")
